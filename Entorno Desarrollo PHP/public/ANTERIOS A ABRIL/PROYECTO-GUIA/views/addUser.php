...
<div class="container"> 
   <h5>Introduce los datos:</h2>
    ...
    <form class="form" action="index.php?controller=UserController&action=comprobarUser" method="post">

  <div class="form-group mb-4">
            <label class="form-label" for="nick">Usuario:</label>
            <input class="form-control" id="nick" type="text"  maxlength="15" value="" ><br>
            <?php
